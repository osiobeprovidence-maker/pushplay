  ...
  return (
    <div className="max-w-7xl mx-auto p-6 py-12 md:py-16">
      ...
      <div className="grid md:grid-cols-2 gap-6">
        <Button to="/signup" variant="brand" className="w-full flex items-center justify-center gap-2 px-6 py-3 rounded-2xl h-14">
        ...
        <Button to="/login" variant="outline" className="w-full flex items-center justify-center gap-2 px-6 py-3 rounded-2xl h-14">
          Sign In
          <svg className="w-4 h-4" viewBox="0 0 24 24">
